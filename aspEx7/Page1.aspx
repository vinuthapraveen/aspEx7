<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Page1.aspx.cs" Inherits="aspEx7.Page1" %>
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td class="auto-style2">
                    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="dataset" />
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                        ...
                        <ItemTemplate>
                            <table class="auto-style3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Image ID="Image1" runat="server" Height="67px" ImageUrl='<%# Eval("photo") %>' Width="69px" />
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
